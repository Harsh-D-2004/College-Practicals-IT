...
public class HatchBack implements Car {
    private String carName = "HatchBack";
    ...
    public void construct() {
        System.out.println("Constructing HatchBack...");
        System.out.println();
        constructEngine();
        carFrame();
        displayInfo();
    ...
    private void constructEngine(){
        ...
        System.out.println(engine + " engine added to HatchBack.");
        System.out.println();
    }
    private void carFrame(){
        ...
        System.out.println(carMaterial + " is Used to Build Car Frame.");
        System.out.println();
    }
